...
class SuppliersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supplier" do
    assert_difference('Supplier.count') do
      post suppliers_url, params: { supplier: { numero_proveedor: @supplier.numero_proveedor } }
    end
  ...
  test "should update supplier" do
    patch supplier_url(@supplier), params: { supplier: { numero_proveedor: @supplier.numero_proveedor } }
