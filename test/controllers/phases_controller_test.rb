...
class PhasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phase" do
    assert_difference('Phase.count') do
      post phases_url, params: { phase: { admin_user_id: @phase.admin_user_id, descripcion: @phase.descripcion, moneda: @phase.moneda, nomenclatura: @phase.nomenclatura, valor: @phase.valor } }
    end
  ...
  test "should update phase" do
    patch phase_url(@phase), params: { phase: { admin_user_id: @phase.admin_user_id, descripcion: @phase.descripcion, moneda: @phase.moneda, nomenclatura: @phase.nomenclatura, valor: @phase.valor } }
